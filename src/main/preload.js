...
contextBridge.exposeInMainWorld('api', {
  ...
  stockBulkFixBatch: (id, moves) => ipcRenderer.invoke('stock:bulkFixBatch', { id, moves }),
  roomsGet: () => ipcRenderer.invoke('rooms:get'),
  roomsSetCount: (payload) => ipcRenderer.invoke('rooms:setCount', payload),
